...
import { descargarReciboPDF, descargarReciboJPG } from '../core/recibo.js';
...
function showReciboConfirm(p) {
  ...
  $('reciboBody').innerHTML = `
    ...
    <div class="btn-row" style="margin-top:14px">
      <button class="btn btn-gold" style="flex:1" onclick="App.descargarUltimoReciboPDF()">📄 Recibo PDF</button>
      <button class="btn btn-primary" style="flex:1" onclick="App.descargarUltimoReciboJPG()">🖼 Recibo JPG</button>
    </div>`;
